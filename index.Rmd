...
The idea of the book is to help create a shared mental model of what it means to run R in production within your organisation.
...
This book is not about code. It's not about writing highly performant or secure code. It's about what it takes from a technology and governance perspective to deliver R into an organisation. It's about the considerations that must be made and how to implement them. Many of the lessons here are transferable to other languages and technologies, but we'll discuss everything specifically from the R perspective to ensure we stay focused on what we're trying to deliver to our end users.
...
Because of R's strength in statistics it has become one of the primary languages used today for modern data science.
...
When people outside of the data science world look at the work of a data scientist, it's easy to mistake it for software development and indeed there are many similarities and places where the two disciplines cross over. However, the main output of software development is software, whereas for data science, the main outputs are insight and knowledge.

Programming is simply a means to an end as the computer can provide, in the right hands, a powerful tool to help understand the world around us through data.
