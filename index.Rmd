...
If you're an **R user** looking for more information on _writing_ R for production use cases, this book isn't really about that, so check the [resources for writing production R](/writing-production-r/) page instead.
